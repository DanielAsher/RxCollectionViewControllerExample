...
let items = Observable.just(
    ["😀 Pairs Game", "🙉 Whack a mole", "😀 Pairs Game"]
...
class CollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        items.bindTo(collectionView!.rx.items(cellIdentifier: "Cell", cellType: CollectionViewCell.self)) 
        { (row: Int, game: GameInfo, cell: CollectionViewCell) in 
            print("cell.gameTitle", cell.gameTitle?.text ?? "nil")
